    ...
    return (
        <div className='mx-16 p-5 text-gray-900 h-screen' id='projects'>
            <div className='flex flex-row items-center mb-16'>
                ...
                <h1 className='mx-4 text-4xl font-bold underline underline-offset-8 decoration-pink-500/30'>My projects</h1>
            </div>
            <div className='flex flex-row gap-8'>
                <Card className='bg-transparent w-1/2'>
                    <CardHeader>
                        <CardTitle>EventoX</CardTitle>
                        <CardDescription>
