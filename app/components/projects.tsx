...
function projects() {
    return (
        <div className=' text-gray-900 h-screen' id='projects'>
            <div className='flex flex-row items-center mb-16'>
                <Presentation className='w-8 h-8' />
                <h1 className='mx-4 text-4xl font-bold'>My projects</h1>
            </div>
            <div className='flex flex-row gap-16'>
                <Card className='w-1/2 bg-gray-300 rounded-xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 p-8 shadow-lg border-none'>
                    <CardHeader>
