...
function About() {
    ...
    return (
        <div id='about'>
            <div className='text-gray-900 mt-40 mb-20'>
                <div className='bg-gray-300 rounded-xl bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 p-16 shadow-lg '>


                    <div className='flex flex-row items-center mb-16'>
                        <User2 className='w-8 h-8' />
                        <h1 className='mx-4 text-4xl font-bold '>Who I am</h1>
                    </div>
